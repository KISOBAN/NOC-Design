...
SC_MODULE(arbiter) {
    ...
    sc_in<sc_uint<7>  >  req0; //each request contains a h/t bit, 'empty bit', 4 bit destination address. It is 7 bits because SystemC syntax would give an error if we use all 6 bits
